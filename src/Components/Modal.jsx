  ...
  return (
    <div >
     <div className="fixed inset-0  rounded-3xl w-fit  block -top-6  left-2/3   z-50" >
      ...
      <button 
          className="absolute top-2 right-2  inline text-white hover:text-gray-800"
          onClick={onClose}
        >
